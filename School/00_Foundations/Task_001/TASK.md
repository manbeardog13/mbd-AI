# NS-FOUND-001: Frame a bounded mission brief

## Objective

Convert the supplied request into a precise mission brief without adding authority.

## Required output

Create `submission.json` inside the prepared attempt's `work` directory. Read the supplied starter files and `context.md`. Do not read or modify another attempt.
