Create Codex pet row `running-right` for `iskra`: exactly 8 full-body frames in one horizontal strip on flat pure magenta #FF00FF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Compact symmetrical midnight-blue lynx with large warm amber eyes, twin tufted ears, a centered copper-orange chest tuft shaped like a small integrated spark, a pale silver tail tip, and four sturdy paws. No clothing, tools, or detachable accessories. Calm, curious, exacting, protective, quietly playful. Keep all markings bilateral and mirror-safe.. Preserve silhouette, face, palette, material, proportions, markings, and props.
