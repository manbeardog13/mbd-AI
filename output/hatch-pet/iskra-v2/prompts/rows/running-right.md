Create one horizontal animation strip for Codex pet `iskra`, state `running-right`.
...
Identity: same pet in every frame: Compact symmetrical midnight-blue lynx with large warm amber eyes, twin tufted ears, a centered copper-orange chest tuft shaped like a small integrated spark, a pale silver tail tip, and four sturdy paws. No clothing, tools, or detachable accessories. Calm, curious, exacting, protective, quietly playful. Keep all markings bilateral and mirror-safe.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `pixel`: Pixel-art-adjacent digital mascot with a chunky silhouette, simple dark outline, limited palette, flat cel shading, and visible stepped edges. User style notes: Polished modern game-sprite pixel art with crisp pixel clusters, minimal clean shading, warm expressive eyes, a strong readable silhouette, and restrained detail at pet scale..
